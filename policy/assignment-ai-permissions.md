...
- what students must show or submit
...
{% include typography/callout.html type="warning" title="Too much detail can backfire" text="Assignment-level policy language should be short. If every assignment contains a full legal code, students will stop reading it. The goal is to clarify the learning boundary, not list every possible tool behavior." %}
